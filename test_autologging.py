...
mlflow.set_experiment("autolog02_experiment_diabetes")
...
mlflow.set_experiment("sklearn_autolog02_experiment_diabetes")
...
# Experimento con mlflow.sklearn.autolog()
mlflow.set_experiment("xgboost_autolog02_experiment_diabetes")
